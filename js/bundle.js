...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, altimg, title, descr, price, parentSelector) {
...
// Чтобы forms.js не ругался и видел их 
...
function openModal(modalSelector, modalTimerId) {
  ...
  document.body.style.overflow = 'hidden'; //проверка есть ли modalTimerId
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(function (item) {
    // так как мы указывае openModal(modalSelector) а не openModal
    // что бы функция openModal не сразу срабтала (при чтении кода)
    // оборачиваем её в стрелочную
    item.addEventListener('click', function () {
      return openModal(modalSelector, modalTimerId);
    });
  }); // сработает только после клика 
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (modal); // именованный ехпорт для forms.js
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent();
  tabsParent.addEventListener('click', function (item) {
    var target = item.target; // убираем точку у селектора, тк подстав в класс
...
// postData - функция работающая с сервером
// называют Сервисом, желательно вынести в отдельно
...
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/slider */ "./js/modules/slider.js");
 //По sistema ES6
// Все импорты помещаются до события 'DOMContentLoaded'
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-01-31');
